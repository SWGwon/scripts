void separateTwoDetectors(TString inputFileName) {
    ...
    for (int event_i = 0; event_i < inputTree->GetEntries(); ++event_i) {
        ...
        for (int i = 0; i < 1000; ++i) {
            ...
            SFGD_neutronPz[i] = {};
            SFGD_neutronId[i] = {};
            SFGD_daughterParentId[i] = {};
            SFGD_delay[i] = {};
            SFGD_t_t0[i] = {};
            SFGD_t_spill[i] = {};
            SFGD_t_gamma_time[i] = {};
            SFGD_t_neutron_time = {};
            SFGD_neutronParentId[i] = {};
            SFGD_neutronParentPDG[i] = {};
            SFGD_neutronTrackId[i] = {};
            SFGD_neutronTrackPDG[i] = {};
            SFGD_neutronTrackAng[i] = {};
            SFGD_t_id[i] = {};
            SFGD_t_length[i] = {};
            SFGD_nTrackId[i] = {};
            SFGD_nParentId[i] = {};
            ...
            USJ_neutronPz[i] = {};
            USJ_neutronId[i] = {};
            USJ_daughterParentId[i] = {};
            USJ_delay[i] = {};
            USJ_t_t0[i] = {};
            USJ_t_spill[i] = {};
            USJ_t_gamma_time[i] = {};
            USJ_t_neutron_time = {};
            USJ_neutronParentId[i] = {};
            USJ_neutronParentPDG[i] = {};
            USJ_neutronTrackId[i] = {};
            USJ_neutronTrackPDG[i] = {};
            USJ_neutronTrackAng[i] = {};
            USJ_t_id[i] = {};
            USJ_t_length[i] = {};
            USJ_nTrackId[i] = {};
            USJ_nParentId[i] = {};
        ...
        for (int i = 0; i < 1000; ++i) {
            SFGD_pointPositionX[i] = {};
            SFGD_pointPositionY[i] = {};
            SFGD_pointPositionZ[i] = {};
            SFGD_pointProcess[i] = {};
            SFGD_pointSubProcess[i] = {};
            SFGD_nElastic[i] = {};
            USJ_pointPositionX[i] = {};
            USJ_pointPositionY[i] = {};
            USJ_pointPositionZ[i] = {};
            USJ_pointProcess[i] = {};
            USJ_pointSubProcess[i] = {};
            USJ_nElastic[i] = {};
        }
        for (int i = 0; i < 1000; ++i) {
            //SFGD
